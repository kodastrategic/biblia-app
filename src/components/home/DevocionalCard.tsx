...
export function DevocionalCard({ currentDay, totalDays, day, isComplete, onOpen }: DevocionalCardProps) {
  return (
    <button
      onClick={onOpen}
      className="group w-full relative overflow-hidden clip-card rounded-3xl border border-amber-400/25 bg-gradient-to-br from-amber-400/12 via-orange-500/8 to-amber-400/5 hover:border-amber-400/50 hover:from-amber-400/18 hover:via-orange-500/12 hover:to-amber-400/8 p-6 md:p-8 transition-all active:scale-[0.99] text-left"
    >
      <div className="absolute -top-20 -right-20 w-56 h-56 rounded-full bg-[radial-gradient(circle_at_center,rgba(251,191,36,0.2)_0%,transparent_70%)]" />
      <div className="absolute -bottom-16 -left-16 w-40 h-40 rounded-full bg-[radial-gradient(circle_at_center,rgba(249,115,22,0.18)_0%,transparent_70%)]" />
